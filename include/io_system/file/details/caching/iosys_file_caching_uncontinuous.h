...
__synapse_iosys_file_caching_uncontinuous*
__synapse_iosys_file_caching_uncontinuous_initialize(synapse_iosys_base						*,
													 synapse_iosys_uncontinuous_memory_model*,
													 synapse_iosys_uncontinuous_memory_model*);

void
__synapse_iosys_file_caching_uncontinuous_cleanup		   (__synapse_iosys_file_caching_uncontinuous*);
